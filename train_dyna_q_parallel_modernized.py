...
def run_experiment(task_name: str, run_id: int, init_group: str):
    env, test_env, state_discretizer_t, action_discretizer_t, state_discretizer_b, action_discretizer_b, configs \
        ...
        while current_step < num_steps_to_sample:
            ...
            if (
                ...
                if configs["save_mdp_graph"]:
                    try:
                        agent.transition_table_env_t.save_mdp_graph(graph_path, use_encoded_states=False)
