...
# Example usage
x = np.array([0.89, 0.65, 0.63, 0.46, 0.26, 0.25, 0.81, 0.55, 0.52, 0.32, 0.17])
y = np.array([0.04, 0.04, 0.045, 0.05, 0.13, 0.05, 0.04, 0.04, 0.035, 0.03, 0.028])
z = np.array([0.44, 0.42, 0.42, 0.41, 0.26, 0.28, 0.43, 0.38, 0.37, 0.32, 0.28])
